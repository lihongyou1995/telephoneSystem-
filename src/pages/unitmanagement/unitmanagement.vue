    ...
    <div class="unitstructure_cor">
      ...
      <div class="unitstructure2">
        ...
        <div class="Framework" style="padding:0;">
          <ul>
            <li>
              <span class="left_name">上级单位</span>
              <span>{{unitInfo.companyunit}}</span>
            </li>
            <li>
              <span class="left_name">单位名称</span>
              <span>{{unitInfo.unitname}}</span>
            </li>
            <li>
              <span class="left_name">单位级别</span>
              <span>{{unitInfo.unitlevel}}</span>
            </li>
            <li>
              <span class="left_name">单位属性</span>
              <span>{{unitInfo.superiorunit}}</span>
            </li>
            <li>
              <span class="left_name">单位类别</span>
              <span>{{unitInfo.unitattribute}}</span>
            </li>
            <li>
              <span class="left_name">值班室电话</span>
              <span>{{unitInfo.DutyRoomTelephone}}</span>
            </li>
            <li>
              <span class="left_name">单位代号</span>
              <span>{{unitInfo.unitcode}}</span>
            </li>
            <li>
              <span class="left_name">单位驻地</span>
              <span>{{unitInfo.unitresident}}</span>
            </li>
          </ul>
        </div>
      </div>
        ...
        <el-form>
          ...
          >
            <el-select
              ...
              v-model="addways"
              @change="addfangshi"
              :disabled="ifdisable==1?true:false"
            >
          ...
          <el-form-item label="* 单位级别" :label-width="formLabelWidth">
            <el-select
              v-model="addForm.unitlevel"
              @visible-change="visiblefn"
              :filter-method="treefn"
              filterable
              placeholder="请输入关键词"
            >
          ...
          <el-form-item label="* 单位属性" :label-width="formLabelWidth">
            <el-select
              v-model="addForm.superiorunit"
              @visible-change="visiblefn"
              :filter-method="treefn2"
              filterable
              placeholder="请输入关键词"
            >
              <el-option v-model="addForm.unitlevel">
          ...
          <el-form-item label="* 单位类型" :label-width="formLabelWidth">
            <el-select
              v-model="addForm.unitattribute"
              @visible-change="visiblefn"
              :filter-method="treefn3"
              filterable
              placeholder="请输入关键词"
            >
              <el-option v-model="addForm.unitlevel">
          ...
          <el-form-item label="* 值班室电话" :label-width="formLabelWidth">
            <el-input
              autocomplete="off"
              type="tel"
              v-model="addForm.DutyRoomTelephone"
