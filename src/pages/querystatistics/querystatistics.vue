    ...
    <div class="content" v-show="!isdetails">
      <div class="querystatisticssosuo">
        ...
        <div class="que2">
          ...
          <el-date-picker @change="datechange" v-model="firstDate" type="date" placeholder="选择日期"></el-date-picker>
        </div>
        <div class="que2">
      ...
      <div class="table">
        <el-table :data="tableData" style="width: 100%" :header-cell-style="getRowClass" border>
          <el-table-column
            prop="tableName"
            label="表名"
            align="center"
